...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3 class="breadcrumb-header">About Us <i class="fa fa-cogs"></i></h3>
                </div>
                <div id="main-wrapper">
                    <div class="row">
		...
		$query_check = "SELECT * FROM tbl_aboutus AS a, tbl_level AS l WHERE l.level_id=a.abtus_level";
                                        ...
                                        <div class="panel panel-white">
                                            <div class="panel-body">
                                                <div class="timeline-item-header">
                                                    ...
                                                    <p>Level : <span><?php echo  $data['level_name']; ?></span></p> <!--Level Name-->
                                                </div>
                                                <div class="timeline-item-post">
                                                    <div class="col-md-12">
                                                        <img src='aboutUsImage/<?php echo $data['featured_image']; ?>' class="img-responsive img-rounded" alt=""> <br>
                                                        <p><?php echo $data['about_us_text']; ?></p>
														<a href="updateAboutUs.php?id=<?php echo $data['abt_id']; ?>">
