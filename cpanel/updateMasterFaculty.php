...
<!DOCTYPE html>
    ...
    <head>
        ...
        <!-- Title -->
        <title>Triton - Master Streams Update</title>
        <!-- Styles -->
...
if(isset($_GET['id'])){
	$id=$_GET['id'];
	$query_check = "SELECT * FROM tbl_masterFaculty WHERE faculty_id='$id'";
                        ...
                        <ul class="accordion-menu">
                            ...
                            <li class="active-page">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a class="active" href="masterFaculty.php">Master</a></li>
                                </ul>
                            </li>
                            <!--Medias-->
                            <li class="">
            ...
            <div class="page-content">
                ...
                <div class="page-inner">
                    <div class="page-title">
                        <h3 class="breadcrumb-header">Update Streams || Masters <i class="fa"></i></h3>
                    </div>
                    <div id="main-wrapper">
                        <div class="row">
                            <div class="col-md-12">
...
if(isset($_POST['update'])){
	...
	if($_FILES['file']['name'] == TRUE){
		...
		if($ext=='gif'|| $ext =='png' || $ext=='jpg'){
			...
			move_uploaded_file($_FILES['file']['tmp_name'],'masterFacultyImage/'.$new_name);

			unlink("masterFacultyImage/".$oldFile);

			$update= "UPDATE tbl_masterFaculty SET description='$description',  featured_image='$new_name' WHERE faculty_id='$id'";

			$conn->query($update);

			header("location:masterFaculty.php?update=success");
		}else{
			header("location:updateMasterFaculty.php?file=fail");
		}
	}else{
				$update= "UPDATE tbl_masterFaculty SET description='$description' WHERE faculty_id='$id'";
