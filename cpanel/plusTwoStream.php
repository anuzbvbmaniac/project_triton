...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3 class="breadcrumb-header">+2 Streams <i class="fa"></i></h3>
                </div>
                <div id="main-wrapper">
                    <div class="row">
		...
		$query_check = "SELECT * FROM tbl_plusTwoStream";
                                        ...
                                        <div class="panel panel-white">
                                            <div class="panel-body">
                                                <div class="timeline-item-header">
                                                    <p><?php echo  $data['stream_id']; ?>. <?php echo $data['stream_name']; ?></p><br>
                                                </div>
                                                <img src='plusTwoStreamImage/<?php echo $data['featured_image']; ?>' class="img-responsive" alt="">
                                                <div class="timeline-item-post">
                                                    <p>
                                                     <?php echo $data['description']; ?>
                                                    </p>
                                                    <div class="timeline-options">
                                                        <a><i class="fa fa-building"></i>+2</a>
                                            ...
                                            <a class="btn btn-success" href="updateStream.php?id=<?php echo $data['stream_id']; ?>">Update</a>
