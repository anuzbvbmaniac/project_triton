...
<head>
    ...
    <!-- Title -->
    <title>Triton - Welcome Message</title>
    <!-- Styles -->
        ...
        <div class="page-content">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3 class="breadcrumb-header">Welcome Message <i class="fa"></i></h3>
                </div>
                <div id="main-wrapper">
                    <div class="row">
                                        ...
                                        <div class="panel panel-white">
                                            <div class="panel-body">
                                                <div class="timeline-item-header">
                                                    <p><?php echo  $data['level_name']; ?></p><br>
                                                </div>
												<div class="col-sm-4">
                                                <img src='welcomeMessageImage/<?php echo $data['image']; ?>' class="img-responsive" alt=""></div>
												<div class="col-sm-8">
