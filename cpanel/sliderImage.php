...
<head>
    ...
    <!-- Title -->
    <title>Triton - Slider Images</title>
    <!-- Styles -->
                    ...
                    <ul class="accordion-menu">
						...
						<li class="active-page">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a class="active" href="sliderImage.php">Slider Images</a></li>
                                </ul>
                        </li>
						<!--News And Notices-->
						<li>
        ...
        <div class="page-content">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3 class="breadcrumb-header">Slider Image <i class="fa"></i></h3>
                </div>
                <div id="main-wrapper">
                    <div class="row">
                                        ...
                                        <div class="panel panel-white">
                                            <div class="panel-body">
                                                <div class="timeline-item-header">
                                                    <p class="text-center" style="margin-bottom: 10px;"><?php echo $data['level_name']; ?> <i class="fa fa-building"></i> </p>
                                                    
                                                </div>
                                                <img style="min-height: 205px;" src='sliderImage/<?php echo $data['image_name']; ?>' class="img-responsive" alt="">
                                            ...
                                            <a  class="btn btn-success center-block" href="updateSliderImage.php?id=<?php echo $data['image_id']; ?>" >UPDATE</a>
