...
<!DOCTYPE html>
    ...
    <head>
        ...
        <!-- Title -->
        <title>Triton - Welcome Message > Update Welcome Message</title>
        <!-- Styles -->
            ...
            <div class="page-content">
                ...
                <div class="page-inner">
                    <div class="page-title">
                        <h3 class="breadcrumb-header">Welcome Message > Update <i class="fa"></i></h3>
                    </div>
                    <div id="main-wrapper">
                        <div class="row">
                            <div class="col-md-12">
				...
				<form lpformnum="1" method="POST" enctype = "multipart/form-data">
					<fieldset>
						...
						<div class="form-group">
							...
							<textarea type="text" required="required" name="welcomeMsg" class="form-control" id="" aria-describedby=""  cols="30" rows="8"><?php echo $data['msg']; ?></textarea> 
