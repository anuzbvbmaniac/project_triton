        ...
        <div class="page-content">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3 class="breadcrumb-header">Bachelor Faculty <i class="fa"></i></h3>
                </div>
                <div id="main-wrapper">
                    <div class="row">
	<?php 
                                        ...
                                        <div class="panel panel-white">
                                            <div class="panel-body">
                                                <div class="timeline-item-header">
                                                    <p><?php echo  $data['faculty_id']; ?>. <?php echo $data['faculty']; ?></p><br>
                                                </div>
                                                <img src='bachelorFacultyImage/<?php echo $data['featured_image']; ?>' class="img-responsive" alt="">
                                                <div class="timeline-item-post">
                                                    <p>
                                                     <?php echo $data['description']; ?>
                                                    </p>
                                                    <div class="timeline-options">
                                                        <a><i class="fa fa-building"></i>Bachelors</a>
                                            ...
                                            <a class="btn btn-success" href="updateBachelorFaculty.php?id=<?php echo $data['faculty_id']; ?>">Update</a>
