...
if(isset($_POST['update'])){
    ...
    if($_FILES['file']['name'] == TRUE){
        ...
        if($ext=='gif'|| $ext =='png' || $ext=='jpg'){
            ...
            move_uploaded_file($_FILES['file']['tmp_name'],'plusTwoStreamImage/'.$new_name);

            unlink("plusTwoStreamImage/".$oldFile);

            $update= "UPDATE tbl_plusTwoStream SET description='$description',  featured_image='$new_name' WHERE stream_id='$id'";

            $conn->query($update);

            header("location:plusTwoStream.php?update=success");
        }else{
            header("location:updateStream.php?file=fail");
        }
    }else{
        $update= "UPDATE tbl_plusTwoStream SET description='$description' WHERE stream_id='$id'";
...
if(isset($_GET['id'])){
	$id=$_GET['id'];
	$query_check = "SELECT * FROM tbl_plusTwoStream WHERE stream_id='$id'";
	...
	while($data = $result->fetch_array())
	{
                        ...
                        <div class="page-sidebar-menu">
                            <ul class="accordion-menu">
                                ...
                                <li class="active-page">
                                    ...
                                    <ul class="sub-menu">
                                        <li><a class="active" href="plusTwoStream.php">+2</a></li>
        ...
        <div class="page-inner">
            <div class="page-title">
                <h3 class="breadcrumb-header">Update Stream || +2 </h3>
            </div>
            <div id="main-wrapper">
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-white">
                            <form lpformnum="1" method="POST" enctype = "multipart/form-data">
                               <fieldset>
                                  ...
                                  <input type="hidden" name="id" value="<?php echo $data['stream_id']?>"/>
