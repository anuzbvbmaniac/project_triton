...
if(isset($_POST['publish'])){
	...
	if($_FILES['file']['name'] == TRUE){
		...
		if($ext=='gif'|| $ext =='png' || $ext=='jpg' || $ext=='pdf' || $ext=='docx' || $ext=='txt' || $ext=='pptx' || $ext=='xlsx'){
			...
			$insert= "INSERT INTO tbl_notice (notice_id, notice_for, notice, notice_content, publish_date, notice_file) VALUES (NULL, '$level', '$noticeTitle', '$noticeContent', '$date', '$new_name')";
			$conn->query($insert);
	...
	$insert= "INSERT INTO tbl_notice (notice_id, notice_for, notice, notice_content, publish_date, notice_file) VALUES (NULL, '$level', '$noticeTitle', '$noticeContent', '$date', 'File Not Added')";
			$conn->query($insert);
			header("location:notice.php?succ=insert");
	}
}
...
<body>
        ...
        <div class="page-content">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3 class="breadcrumb-header">Notices <i class="fa"></i></h3>
                </div>
                <div id="main-wrapper">
                    <div class="row">
	...
	$query_check = "SELECT * FROM tbl_notice AS n, tbl_level AS l WHERE l.level_id=n.notice_for";
		...
		while($data = $result->fetch_array())
		{
			?>
				...
				if ($data['notice_file']=='File Not Added'){
					...
					?>
                                                            <p>
                                                                <a href="noticeFiles/<?php echo $data['notice_file'] ?>">
                                                                    <?php echo $data['notice']; ?>
                                                                </a>
                                                            </p>
                                                            <?php
				...
				?>
                                                            ...
                                                            <small><?php echo  $data['publish_date']; ?></small>
                                                    </div>
                                                ...
                                                <a class="btn btn-danger pull-right" href="javascript:confirmDelete('deleteNotice.php?id=<?php echo $data['notice_id']; ?>')">Delete</a>
                                            </div>
                                        </li>
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Publish Notices</h4>
                                </div>
                                ...
                                <div class="panel-body">
                                    <form lpformnum="1" method="POST" enctype = "multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required="required" name="title" class="form-control" placeholder="Enter Notice">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Notice Content</label>
                                            <textarea type="text" required="required" name="notice_content" id="" aria-describedby="" placeholder="Enter Notice" class="form-control" name="" id="" cols="30" rows="10"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Level</label>
