        ...
        <div class="page-content">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3 class="breadcrumb-header">Feedback <i class="fa"></i></h3>
                </div>
                <div id="main-wrapper">
                    <div class="row">
                        <?php
			...
			while($data = $result->fetch_array())
			{
				...
				?>
                                                ...
                                                <div class="panel panel-white">
                                                    <div class="panel-body">
                                                        <div class="timeline-item-header">
                                                            <p>SN.
                                                                <?php echo ++$counter; ?> - <span>FeedBack In (Level) : <?php echo $data['level_name']; ?></span></p>
                                                            <small><?php echo $data['feedback_date']; ?></small>
                                                        </div>
                                                        <div class="timeline-item-post">
                                                            ...
                                                            <div class="timeline-options">
                                                                <a><i class="fa fa-user-circle"></i><?php echo $data['feedback_by']; ?></a>
                                                                <a><i class="fa fa-phone"></i> <?php echo $data['phone']; ?></a>
                                                                <?php
					if($data['email']=="Email Not Available"){
						...
						?>
                                                                    <a href="https://mail.google.com"><i class="fa fa-envelope"><?php echo $data['email']; ?></i></a>
                                                                    <?php
					}
					?>
