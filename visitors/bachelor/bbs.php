...
<body>
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php"><img class="img-responsive" src="img/logo2.png" alt="company logo" width="200" height="60"></a> </div>
      ...
      <ul class="nav navbar-nav navbar-right custom-menu animated slideInLeft">
        ...
        <li class="dropdown"> <a href="Streams.php" class="dropdown-toggle" data-toggle="dropdown">Streams <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li class="active"><a href="bbs.php">BBS</a></li>
