...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
   ...
   $query_check = "SELECT * FROM tbl_sliderimage WHERE level_image=3 AND image_id=7";
   $result = $conn->query( $query_check );
   $data=$result->fetch_array();
   ?>
   <div class="item active"> <img src="../../cpanel/sliderImage/<?php echo $data['image_name']?>" alt="First slide"> </div>
   <?php
   $query_check = "SELECT * FROM tbl_sliderimage WHERE level_image=3 AND image_id=8";
   $result = $conn->query( $query_check );
   $data1=$result->fetch_array();
   ?>
   <div class="item"> <img src="../../cpanel/sliderImage/<?php echo $data1['image_name']?>" alt="Second slide"> </div>
   <?php
   $query_check = "SELECT * FROM tbl_sliderimage WHERE level_image=3 AND image_id=9";
   $result = $conn->query( $query_check );
 ...
 <div class="about">
  <div class="container">
    <div class="row">
     <?php
     $query_check = "SELECT * FROM tbl_wlcmMsg WHERE msg_id=3";
     $result = $conn->query( $query_check );
     $data = $result->fetch_array();
     ?>
...
<div class="courses">
  <div class="container">
    <div class="row">
      ...
      <div class="row">
        <?php
        $query_check = "SELECT * FROM tbl_bachelorFaculty";
        $result = $conn->query( $query_check );
...
<div class="index-content">
  <div class="container">
   <div class="row">
    <?php
    require_once('../../connection.php');
    $query_check = "SELECT * FROM tbl_news WHERE news_level=3";
    $result = $conn->query( $query_check );
    $data = $result->fetch_array();
    if (empty($data)){
      ?>
      ...
      $query_check = "SELECT * FROM tbl_news WHERE news_level=3 LIMIT 3";
      $result = $conn->query( $query_check );
      while($data=$result->fetch_array()){
        ?>
        <div class="col-lg-4 wow slideInLeft">
        ...
        <div class="carousel slide" data-ride="carousel" id="quote-carousel"> 
          ...
          <div class="gallery">
           <div class="container">
            <?php
            require_once('../../connection.php');
            $query_check = "SELECT * FROM tbl_gallery WHERE image_in=3 LIMIT 3";
            $result = $conn->query( $query_check );
            $data = $result->fetch_array();
            if (empty($data)){
              ?>
