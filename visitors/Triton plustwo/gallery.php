...
<body>
	 ...
	 <div class="top top-style3">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="flat-information animated slideInRight">
                                <li>Sun - Fri: 8.00AM - 6:00PM </li>
	 ...
	 <div class="container">
			<a class="logo" href="#">
				<img class="img-responsive" src="img/Triton-International.png" width="278" height="82" alt="Triton International College">
			</a>
		</div>
	<!--Responsive NavBar-->
	<nav class="navbar navbar-inverse">
      <div class="contaier-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          ...
          <li><a href="humanities.php">Humanitites</a></li>
              </ul>
          </li>
	...
	<div class="gallery">
  	<div class="container">
  		<div class="row">
      			...
      			<div class="col-lg-4 col-sm-4 col-xs-6 wow slideInRight"><a title="Image 1" href="#"><img class="thumbnail img-responsive" src="img/backgroundimage.jpg"></a></div>
      			<div class="col-lg-4 col-sm-4 col-xs-6"><a title="Image 2" href="#"><img class="thumbnail img-responsive" src="img/backgroundimage.jpg"></a></div>
      			<div class="col-lg-4 col-sm-4 col-xs-6"><a title="Image 3" href="#"><img class="thumbnail img-responsive" src="img/backgroundimage.jpg"></a></div>
      			<div class="col-lg-4 col-sm-4 col-xs-6"><a title="Image 4" href="#"><img class="thumbnail img-responsive" src="img/backgroundimage.jpg"></a></div>
      			<div class="col-lg-4 col-sm-4 col-xs-6"><a title="Image 5" href="#"><img class="thumbnail img-responsive" src="img/backgroundimage.jpg"></a></div>
      			<div class="col-lg-4 col-sm-4 col-xs-6"><a title="Image 6" href="#"><img class="thumbnail img-responsive" src="img/backgroundimage.jpg"></a></div>
      			<div class="col-lg-4 col-sm-4 col-xs-6"><a title="Image 8" href="#"><img class="thumbnail img-responsive" src="img/backgroundimage.jpg"></a></div>
      			<div class="col-lg-4 col-sm-4 col-xs-6"><a title="Image 9" href="#"><img class="thumbnail img-responsive" src="img/backgroundimage.jpg"></a></div>
            <div class="col-lg-4 col-sm-4 col-xs-6"><a title="Image 9" href="#"><img class="thumbnail img-responsive" src="img/backgroundimage.jpg"></a></div>
