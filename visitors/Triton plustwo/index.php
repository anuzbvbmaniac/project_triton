...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    $query_check = "SELECT * FROM tbl_sliderimage WHERE level_image=2 AND image_id=4";
  ...
  <div class="about">
    <div class="container">
      <?php
      $query_check = "SELECT * FROM tbl_wlcmMsg WHERE msg_id=2";
      $result = $conn->query( $query_check );
      $data = $result->fetch_array();
      ?>
      <div class="row">
        <h2>Your Career Path Begins Here</h2>
        <p class="wow pulse"><?php echo $data['msg']?> </span></p>
        <a class="learn-more" href="about.php">Learn More...</a> </div>
      </div>
    </div>
    <div class="courses">
      <div class="container">
        <div class="row">
          ...
          <div class="row">
            <div class="col-md-4 text-center">
              <div class="contain wow rotateInDownLeft"> <a href="science.php" id="science"><img class="hoverAnimation" src="img/Science.png"></a> </div>
            </div>
            <div class="col-md-4 text-center">
              <div class="contain wow rotateIn"> <a id="management" href="management.php"><img src="img/management.png"></a> </div>
            </div>
            <div class="col-md-4 text-center">
              <div class="contain wow rotateInDownRight"> <a id="humanities" href="humanities.php"><img src="img/humanities.png"></a> </div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
       <div class="row">
        ...
        if (empty($data)){
          ...
          $query_check = "SELECT * FROM tbl_news WHERE news_level=2 LIMIT 3";
          $result = $conn->query( $query_check );
      ...
      <div class='col-md-offset-2 col-md-8'>
        ...
        <div class="gallery">
         <div class="container">
          <?php
          require_once('../../connection.php');
          $query_check = "SELECT * FROM tbl_gallery WHERE image_in=2 LIMIT 3";
          $result = $conn->query( $query_check );
          $data = $result->fetch_array();
          if (empty($data)){
            ?>
