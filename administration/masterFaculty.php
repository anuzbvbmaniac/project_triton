...
<head>
    ...
    <!-- Title -->
    <title>Triton - Masters Faculty</title>
    <!-- Styles -->
        ...
        <div class="page-content">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3 class="breadcrumb-header">Masters Faculty <i class="fa"></i></h3>
                </div>
                <div id="main-wrapper">
                    <div class="row">
	<?php 
                                    ...
                                    <li class="timeline-item">
                                        <div class="panel panel-white">
                                            <div class="panel-body">
                                                ...
                                                <img src='masterFacultyImage/<?php echo $data['featured_image']; ?>' class="img-responsive" alt="">
                                                <div class="timeline-item-post">
                                                    <p>
                                                     <?php echo $data['description']; ?>
                                                    </p>
                                                    <div class="timeline-options">
                                                        <a><i class="fa fa-building"></i>Masters</a>
                                            ...
                                            <a class="btn btn-success" href="updateMasterFaculty.php?id=<?php echo $data['faculty_id']; ?>">Update</a>
